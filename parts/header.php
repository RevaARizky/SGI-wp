<header id="header" class="top-0 left-0 right-0 md:pt-[40px] pt-[20px] z-10 fixed">
    <div class="container">
        ...
        <div class="grid grid-cols-3 items-center justify-end relative">
            ...
            <div class="col-span-1 md:block hidden">
                <div class="menu-wrapper flex gap-x-14 justify-start relative items-center">
                    ...
                    <div class="social-media-wrapper flex gap-x-4 absolute right-0 top-1/2 -translate-y-1/2">
                        <div class="social">
                            <a href="#">
