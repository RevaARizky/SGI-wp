...
<section id="<?= esc_attr($id) ?>" class="<?= esc_attr($classes) ?>">
    <div class="container">
        <div class="grid grid-cols-12 relative md:gap-x-16 items-center">
            ...
            <?php if($image) : ?>
                <div class="image-wrapper relative pt-[100%]" data-speed=".89">
                    <img src="<?= $image['url'] ?>" class="absolute inset-0 w-full h-full object-cover" alt="">
                </div>
            <?php endif; ?>
            </div>
            <div class="md:col-span-6 col-span-12 h-full flex items-center px-16 bg-sgi-footer<?= $imageRight ? ' md:order-0' : ' md:order-1' ?>">
                ...
                <div class="text-wrapper mb-6">
                    ...
                    <div class="button-wrapper mt-12">
