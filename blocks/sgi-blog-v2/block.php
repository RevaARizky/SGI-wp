            ...
            <div class="grid grid-cols-12 md:gap-x-10 md:gap-y-16 gap-y-7">
                <?php while($post->have_posts()) : ?>
                    ...
                    <div class="md:col-span-4 col-span-12 item">
                        <div class="inner-wrapper bg-sgi-secondary relative">
                            <a href="<?= get_the_permalink() ?>">
                                <div class="image-wrapper relative pt-[68%]">
                                    ...
                                    <div class="btn md:px-8 px-4 md:py-4 py-2 bg-sgi-orange md:text-xs text-[10px] text-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20" style="opacity: 0; border-radius: 6px;">Read More</div>
                                </div>
                                <div class="text-wrapper px-7 py-10 text-white">
